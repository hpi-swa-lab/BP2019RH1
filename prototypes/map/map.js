...
import { KenyaDistrictTooltip, KenyaIndividualTooltip, SomaliaDistrictTooltip, SomaliaIndividualTooltip } from "./helper-modules/tooltip.js"
import { MapHoverer } from "./helper-modules/mapHoverer.js"
import { IndividualClicker } from "./helper-modules/individualClicker.js"
import { KenyaDataHandler, SomaliaDataHandler } from "./helper-modules/dataHandler.js"
...
class Map {
  ...
  clear() {
    this.drawingCanvas.context.clearRect(0, 0, this.width, this.height)
